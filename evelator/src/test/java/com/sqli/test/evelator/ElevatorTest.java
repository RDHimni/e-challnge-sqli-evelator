package com.sqli.test.evelator;

import static org.junit.Assert.assertEquals;

import org.junit.Test;

import com.sqli.test.evelator.entities.Building;
...
public class ElevatorTest {
    ...
    public void the_closest_elevator_to_floor_zero_should_arrive_first() {
        ...
        Building building = new Building(numberOfFloors, "id2:6", "id1:1");// "[elevator_id]:[elevator_current_floor]"
